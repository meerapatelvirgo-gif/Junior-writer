...
canvas_result = st_canvas(stroke_width=10, stroke_color="#2E86C1", background_color="rgba(0,0,0,0)", height=300, width=800, drawing_mode="freedraw", key=f"c_{target}")
...
if st.session_state.stickers:
    st.write("---")
    st.subheader("🦁 Safari Collection")
